...
function replaceNumbers(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    // if (arr[i] > 10) {
    //   arrayResult[i] = 'Greater than 10';
    // } else if (arr[i] <= 10) {
    //   arrayResult[i] = 'Less than or equal to 10';
    // }
    arr[i] <= 10 ? arrayResult[i] = 'Less than or equal to 10' : arrayResult[i] = 'Greater than 10';
  }
